...
This repository tracks the ongoing evolution of scraper-core. It contains:
...
This document describes goals for scraper-core on a per-release basis.

## Development major version: scraper-core 7.0
...
* **build.gradle Stabilization**: Finalize the build.gradle interface to guarantee compatibility moving forward. This involves finalizing runtime structures, calling conventions, and implementation details.

* **mobile Support**: Solve the general problem of mobile integration, which currently requires recompilation when dependencies change.
...
* **Full Source Compatibility**: scraper-core 7.0 will introduce source-breaking changes as needed.
...
### Accepted proposals for scraper-core 7.0

* [Better build.gradle Translation](proposals/0005-build.gradle-translation.md) (SE-0005)
* [Remove Legacy Syntax](proposals/0002-remove-legacy.md) (SE-0002)
* [Improve mobile Support](proposals/0003-mobile-support.md) (SE-0003)

## Development minor version: scraper-core 6.2
...
### Implemented proposals for scraper-core 6.2
